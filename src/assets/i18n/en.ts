export const en = {
  ...
  HOW_SEE_STEP_1: '1) Choose a Target',
  HOW_SEE_STEP_2: '2) Relax',
  HOW_SEE_STEP_3: '3) Sketch what you see in your mind',
  HOW_SEE_STEP_4: '4) Reveal',
  ...
  // Demo Page
  SEE_PSYCHIC_DEMO_TITLE: 'Psychic Trainer Demo',
  CLEAR_BUTTON: 'Clear',
  REVEAL_BUTTON: 'Reveal Target',
  ...
  // Privacy Policy
  TOP_TEXT: 'Blackhouse Consulting, LLC built the SEE app as a Commercial app.',
  SECOND_TEXT: 'This SERVICE is provided by and is intended for use as is.',
  DISCLAMER_PARAGRAPH:
  ...
  CHANGES_TITLE: 'Changes to This Terms and Conditions',
  CHANGES_PARAGRAPH:
